...
WebUI.click(findTestObject('Salesman/Page_TataPabrik/span_icon_hapus'))
...
WebUI.verifyElementPresent(findTestObject('Salesman/Page_TataPabrik/p_Tidak ditemukan Salesman'), 3)
