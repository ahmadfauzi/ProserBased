...
WebUI.click(findTestObject('PengaturanDiskon/Page_TataPabrik/button_tambah_Pengaturan Diskon'))
...
WebUI.selectOptionByValue(findTestObject('PengaturanDiskon/Page_TataPabrik/select_Customer Invoice'), 'Customer', false)
...
WebUI.verifyMatch(tipeDiskonText, 'Customer', false)
