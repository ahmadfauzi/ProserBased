...
String editedText = "SU-" + randomNumber
...
WebUI.setText(findTestObject('Supplier/Page_TataPabrik/input_Nama Supplier_name'), editedText)
...
WebUI.setText(findTestObject('Object Repository/Supplier/Page_TataPabrik/input_Kode_code'), editedText)
...
WebUI.setText(findTestObject('Supplier/Page_TataPabrik/input_(Tidak wajib diisi)_nik'), editedText)
...
WebUI.setText(findTestObject('Supplier/Page_TataPabrik/input_(Tidak wajib diisi)_npwp'), editedText)
...
WebUI.setText(findTestObject('Salesman/Page_TataPabrik/input_Cari_input'), editedText)

WebUI.delay(2)

String namaSupplierEditText = WebUI.getText(findTestObject('Supplier/Page_TataPabrik/div_namasupplier'))

WebUI.verifyMatch(namaSupplierEditText, editedText, false)