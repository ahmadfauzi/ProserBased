...
if(namabarang == '') {
	...
	String hargaText = WebUI.getAttribute(findTestObject('Object Repository/Page_TataPabrik/DaftarBarang/input_Rp_price'),
		'value')
	
	String numericHargaText = hargaText.replaceAll('[^0-9]', '')
	
	String hargaDataText = harga
	
	String numericDataText = hargaDataText.replaceAll('[^0-9]', '')
	
	WebUI.verifyMatch(numericHargaText, numericDataText, false)
