...
WebUI.click(findTestObject('DaftarBarang/Page_TataPabrik/button_Tambah Bahan Baku'))

WebUI.sendKeys(findTestObject('DaftarBarang/Page_TataPabrik/input_Nama_Bahan Baku'), Keys.chord(Keys.CONTROL, 'a'))

WebUI.sendKeys(findTestObject('DaftarBarang/Page_TataPabrik/input_Nama_Bahan Baku'), Keys.chord(Keys.BACK_SPACE))

WebUI.setText(findTestObject('DaftarBarang/Page_TataPabrik/input_Nama_Bahan Baku'), bahanbaku_edit)

WebUI.sendKeys(findTestObject('DaftarBarang/Page_TataPabrik/input_Quantity'), Keys.chord(Keys.CONTROL, 'a'))

WebUI.sendKeys(findTestObject('DaftarBarang/Page_TataPabrik/input_Quantity'), Keys.chord(Keys.BACK_SPACE))
...
WebUI.setText(findTestObject('DaftarBarang/Page_TataPabrik/input_Nama_Bahan Baku'), bahanbaku)
