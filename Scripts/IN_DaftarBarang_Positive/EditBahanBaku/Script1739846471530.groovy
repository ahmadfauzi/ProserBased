...
if(namabarang == '') {
	...
	WebUI.setText(findTestObject('Object Repository/Page_TataPabrik/DaftarBarang/input_Rp_price'), harga_edit)
	...
	//** Verify field validation **
	 ...
	 if ((namabarang_edit == '') && WebUI.verifyElementPresent(findTestObject('DaftarBarang/Page_TataPabrik/span_Wajib diisi_namabarang'),
		 2)) {
	 ...
	 KeywordUtil.logInfo('get only number Netto =  ' + getOnlyNumberNetto)
	 ...
	 if ((satuanberat_edit == '') && WebUI.verifyElementPresent(findTestObject('DaftarBarang/Page_TataPabrik/span_Wajib diisi_satuanberat'),
		 2)) {
